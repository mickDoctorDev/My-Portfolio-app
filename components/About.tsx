  ...
  return (
    <section id="about" className="py-20 md:py-32 relative">
      ...
      <div className="container mx-auto text-center">
        ...
        <div className="max-w-3xl mx-auto bg-white/5 backdrop-blur-sm p-8 rounded-xl shadow-lg border border-purple-800/50 flex flex-col items-center">
          ...
          <button
            ...
            className="mt-8 inline-block px-8 py-3 bg-transparent border border-purple-400 text-purple-300 font-semibold rounded-full hover:bg-purple-400 hover:text-white transition-all duration-300 transform hover:scale-105 shadow-[0_0_15px_rgba(168,85,247,0.3)] hover:shadow-[0_0_25px_rgba(168,85,247,0.5)]"
          >
            View Full Timeline
          </button>
        </div>
