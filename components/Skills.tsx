...
const SkillCard = ({ skill }: { skill: Skill }) => (
  <div
    className="
      ...
      bg-white/5 backdrop-blur-sm border border-purple-800/30 rounded-xl
    ...
    "
  >
    <div className="w-16 h-16 mb-4 text-purple-400 transition-colors duration-300 group-hover/card:text-purple-600">
      {skill.icon}
    </div>
    <p className="text-lg font-semibold text-gray-300 transition-colors duration-300 group-hover/card:text-purple-900">
      {skill.name}
    </p>
  </div>
);
    ...
    <section id="skills" className="py-20 md:py-32 relative">
      ...
      <div className="container mx-auto text-center">
        ...
        <div className="relative white w-full mx-auto rounded-lg">
          ...
          <div className="absolute rounded-l-3xl top-0 left-0 z-20 w-12 md:w-22 h-full bg-gradient-to-r from-[#4b1980] to-transparent pointer-events-none"></div>
          <div className="absolute rounded-r-3xl top-0 right-0 z-20 w-12 md:w-22 h-full bg-gradient-to-l from-[#4b1980] to-transparent pointer-events-none"></div>
